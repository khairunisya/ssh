...
wget -O /usr/bin/addl2tp http://${jrtunnel}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp http://${jrtunnel}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp http://${jrtunnel}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp http://${jrtunnel}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp http://${jrtunnel}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp http://${jrtunnel}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
