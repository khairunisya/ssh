...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/khairunisya/ssh/main/password"
...
echo "clear" >> .profile
echo "figlet -f slant Jrtunnel - Fastnet | lolcat" >> .profile
echo "sleep 1" >> .profile
echo "clear" >> .profile
echo "neofetch" >> .profile
echo "echo -e \" - Mod By Jrtunnel\" | lolcat" >> .profile
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/khairunisya/ssh/main/badvpn-udpgw64"
...
sed -i 's/DROPBEAR_PORT=22/DROPBEAR_PORT=143/DROPBEAR_PORT=123/g' /etc/default/dropbear
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/khairunisya/ssh/main/squid3.conf"
...
#Forward 443 = ws
wget -O /etc/default/sslh "https://raw.githubusercontent.com/khairunisya/ssh/main/sslh.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/khairunisya/ssh/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/khairunisya/ssh/main/bannerssh.conf"
