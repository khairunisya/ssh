...
wget -qc https://raw.githubusercontent.com/khairunisya/ssh/main/slowdnss/dns2.sh && chmod +x dns2.sh &&  sed -i -e 's/\r$//' dns2.sh && ./dns2.sh
nameserver=$(cat /home/nsdomain)
echo -e "[ ${green}INFO${NC} ] Download File... "
echo "Progress..." | lolcat
# SSH SlowDNS
echo -e " [ ${green}INFO${NC} ] Successfully.. "
wget -qO- -O /etc/ssh/sshd_config https://raw.githubusercontent.com/khairunisya/ssh/main/slowdnss/sshd_config
...
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading files... "
wget -qc -O /etc/slowdns/sldns-server "https://raw.githubusercontent.com/khairunisya/ssh/main/slowdnss/sldns-server"
wget -qc -O /etc/slowdns/sldns-client "https://raw.githubusercontent.com/khairunisya/ssh/main/slowdnss/sldns-client"
sleep 1
